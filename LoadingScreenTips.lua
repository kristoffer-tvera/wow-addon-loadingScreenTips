...
local function RandomLoadingScreenTips()
    return loadingScreenTipsDB[ math.random( #loadingScreenTipsDB ) ];
end

local function LoadingScreenTipsChatCommand(msg, editbox)
...
SLASH_LOADINGSCREENTIPS1, SLASH_LOADINGSCREENTIPS2, SLASH_LOADINGSCREENTIPS3 = '/lst', '/loadingscreentips', '/tips';
SlashCmdList["LOADINGSCREENTIPS"] = LoadingScreenTipsChatCommand
